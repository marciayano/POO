package Aula02;
//Enunciado: Faça uma função que, dado um número, indica se é um número primo ou não.
...
//Para usar esta função que iremos criar, podemos permitir a entrada de apenas um número do usuário
