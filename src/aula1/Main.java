...
Linguagem fortemente tipada == toda variavel deve ter o tipo dela, Java nao permite guardar uma string na variavel double Saldo por exemplo.
...
Programa Java -> Compilador Java Bytecode -> Java Virtual Machine -> Windows, linus, mac...
...
String use (aspas duplas) "string e mais de um caracter"
  char usa (aspas simples) 'char e apenas um caracter'
 */
...
public class Main {
    public static void main(String[] args) {
        ...
        //digite sout + tecla tab para nao precisar digitar system.. e Crtl+D para copy cola
        //para melhorar leitura visual em linhas longas demais (canto superior esquerdo): View - Active Editor - Soft Wrap
