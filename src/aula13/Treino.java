...
método compareTo
recebe como parâmetro o outro objeto com o qual se deseja fazer a comparação e retorna, por exemplo:
...
Com as interfaces, podemos fazer com que:
quem as implementa tenha um método compareTo e possa estabelecer sua própria implementação.

Não precisamos criar uma interface para comparar objetos porque Java tem a sua própria,
é a interface Comparable e é necessário usá-la em outras circunstâncias para comparar objetos,
por exemplo, para ordená-los em coleções.
